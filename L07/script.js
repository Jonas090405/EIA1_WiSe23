...
function handleState0Input() {
    if (input.value.toLowerCase() === "geräusch nachgehen" || input.value.toLowerCase() === "nachgehen") {
        output.innerHTML = storychoices[1];
        state++;
    } else if (input.value.toLowerCase() === "wegrennen" || input.value.toLowerCase() === "rennen") {
...
function handleState1Input() {
    if (input.value.toLowerCase() === "fuß von der steinplatte erheben" || input.value.toLowerCase() === "fuß erheben" || input.value.toLowerCase() === "rennen") {
        output.innerHTML = storyendings[0];
        state++;
        return;
    } else if (input.value.toLowerCase() === "den stein auf die platte legen") {
...
function handleState2Input() {
    if (input.value.toLowerCase() === "linker gang" || input.value.toLowerCase() === "links" || input.value.toLowerCase() === "heller gang") {
        output.innerHTML = storyendings[3];
        state++
    } else if (input.value.toLowerCase() === "rechter gang" || input.value.toLowerCase() === "rechts" || input.value.toLowerCase() === "dunkler gang") {
...
function handleState3Input() {
    if (input.value.toLowerCase() === "lügen") {
        output.innerHTML = storyendings[4];
    } else if (input.value.toLowerCase() === "wahrheit") {
